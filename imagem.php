<?php
	/**
		...
		* @param int $larguraMaximo largura máxima permitida
		* @param int $alturaMaxima altura máxima permitida
		* @param int $tamanhoMaximo tamanho máximo permitido (em bytes: cada 1mb +- 1000000)
		* @param string $caminho diretorio para onde a imagem será movida
		* @return void
	*/
	function uploadImagem($foto, $larguraMaxima, $alturaMaxima, $tamanhoMaximo, $caminho)
	{
